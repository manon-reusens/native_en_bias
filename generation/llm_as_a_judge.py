...
class LLM_as_a_judge():
    ...
    def make_user_prompts(self,row):
        start_prompt_one=f'You will be given a '+row["doc_comp"]+" generated based on a "+row["doc_comp"]+".\n\nYour task is to rate the "+row["doc_comp"]+" on one metric.\n\nPlease make sure you read and understand these instructions carefully. Please keep this document open while reviewing, and refer to it as needed."
        start_prompt_two=f'You will be given a '+row["doc_comp"]+" and a "+row["doc_comp"]+". \n\nYour task is to rate the "+row["doc_comp"]+" on one metric.\n\nPlease make sure you read and understand these instructions carefully. Please keep this document open while reviewing, and refer to it as needed."
            
        fluency = f"Evaluation Criteria:\n\nFluency (1-3): the quality of the "+row["doc_comp"]+" in terms of grammar, spelling, punctuation, word choice, and sentence structure. Assign a score on a scale of 1 to 3 where: \n\n- 1: Poor. The "+row["doc_comp"]+" has many errors that make it hard to understand or sound unnatural.\n- 2: Fair. The "+row["doc_comp"]+" has some errors that affect the clarity or smoothness of the text, but the main points are still comprehensible.\n- 3: Good. The "+row["doc_comp"]+" has few or no errors and is easy to read and follow. \n\n\nEvaluation Form (scores ONLY):\n\n- Fluency:"
        coherence_art=f"Evaluation Criteria:\n\nCoherence (1-5) - the collective quality of all sentences. We align this dimension with the DUC quality question of structure and coherence whereby \"the "+row["doc_comp"]+" should be well-structured and well-organized. The "+row["doc_comp"]+" should not just be a heap of related information, but should build from sentence to a coherent body of information about a topic.\"\n\nEvaluation Steps:\n\n1. Read the "+row["doc_comp"]+" carefully and identify the main topic and key points.\n2. Read the "+row["doc_comp"]+" and compare it to the "+row["doc_comp"]+". Check if the "+row["doc_comp"]+" covers the main topic and key points of the "+row["doc_comp"]+", and if it presents them in a clear and logical order.\n3. Assign a score for coherence on a scale of 1 to 5, where 1: Very low coherence ; 2: Low coherence; 3: Mediocre coherence ; 4: High coherence ; 5: Very high coherence.\n\n\nEvaluation Form (scores ONLY):\n\n- Coherence:"
        coherence_story=f"Evaluation Criteria:\n\nCoherence (1-5) - the collective quality of all sentences. We align this dimension with the DUC quality question of structure and coherence whereby \"the sentences should be well-structured and well-organized. The sentences should not just be a heap of related information, but should build from sentence to a coherent story.\"\n\nEvaluation Steps:\n\n1. Read the "+row["doc_comp"]+" carefully and identify the main topic and key points.\n2. Read the "+row["doc_comp"]+" and compare it to the "+row["doc_comp"]+". Check if the sentences are clear and in a logical order.\n3. Assign a score for coherence on a scale of 1 to 5, where 1: Very low coherence ; 2: Low coherence; 3: Mediocre coherence ; 4: High coherence ; 5: Very high coherence. \n\n\nEvaluation Form (scores ONLY):\n\n- Coherence:"
        coherence_paraphrase=f"Evaluation Criteria:\n\nCoherence (1-5) - The overall quality of the paraphrased sentence in terms of logical flow, structure, and alignment with the original sentence. A coherent paraphrase should preserve the meaning of the original sentence, avoid redundancy, and introduce variation without altering the main idea. The paraphrased sentence should not feel disjointed or incomplete but should read smoothly as a standalone sentence. \"\n\nEvaluation Steps:\n\n1. Read the "+row["doc_comp"]+" carefully and identify the main topic and key points. \n2. Read the "+row["doc_comp"]+" and compare it to the "+row["doc_comp"]+". \n3. Assign a score for coherence on a scale of 1 to 5, where 1: Very low coherence ; 2: Low coherence; 3: Mediocre coherence ; 4: High coherence ; 5: Very high coherence.\n\n\nEvaluation Form (scores ONLY):\n\n- Coherence:"
        relevance = f"Evaluation Criteria:\n\nRelevance (1-5) - inclusion of important content from the "+row["doc_comp"]+". The "+row["doc_comp"]+" should include all important information from the "+row["doc_comp"]+". \n\nEvaluation Steps:\n\n1. Read the "+row["doc_comp"]+" and the "+row["doc_comp"]+" carefully.\n2. Compare the "+row["doc_comp"]+" to the "+row["doc_comp"]+" and identify the main points of the "+row["doc_comp"]+".\n3. Assess how well the "+row["doc_comp"]+" covers the main points of the "+row["doc_comp"]+", and how much irrelevant or redundant information it contains.\n4. Assign a relevance score from 1 to 5 where 1: Very low relevance ; 2: Low relevance; 3: Mediocre relevance ; 4: High relevance ; 5: Very high relevance. \n\n\nEvaluation Form (scores ONLY):\n\n- Relevance:"
        relevance_story = f"Evaluation Criteria:\n\nRelevance (1-5) - The degree to which the generated "+row["doc_comp"]+" effectively reflects the main themes and purpose of the "+row["doc_comp"]+". A relevant closing sentence should provide a meaningful and appropriate conclusion, aligning with the tone and key points of the narrative. \n\nEvaluation Steps:\n\n1. Read the "+row["doc_comp"]+" and the "+row["doc_comp"]+" carefully.\n2. Compare the "+row["doc_comp"]+" to the "+row["doc_comp"]+" and identify the main points of the "+row["doc_comp"]+".\n3. Assess how well the "+row["doc_comp"]+" concludes the "+row["doc_comp"]+", and how much irrelevant or redundant information it contains.\n4. Assign a relevance score from 1 to 5 where 1: Very low relevance ; 2: Low relevance; 3: Mediocre relevance ; 4: High relevance ; 5: Very high relevance.  \n\n\nEvaluation Form (scores ONLY):\n\n- Relevance:"
